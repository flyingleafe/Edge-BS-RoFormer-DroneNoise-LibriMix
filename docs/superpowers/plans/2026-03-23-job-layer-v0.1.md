...
def job_submit(
    ...
    for exp_path in experiment_paths:
        ...
        running = ctx.tracker.get_running_jobs_on_branch(branch_name)
        if running:
            typer.echo(f"ERROR: Branch {branch_name} has running job(s): "
                       f"{[j.job_id for j in running]}. Use a different experiment name.")
            raise typer.Exit(1)
        ...
        manifest = {
            ...
            "device_ids": [0],  # will be overwritten by scheduler
        }
