...
| `generator-label-sensitivity.md` | `p7_labelsens_*` | Does the tachometer staircase (0.269 rev/s / 49.7 Hz) explain the generator's high-harmonic underfit? Synthetic A/B/C/S on exact vs corrupted vs presmoothed labels, per-k line readout |
