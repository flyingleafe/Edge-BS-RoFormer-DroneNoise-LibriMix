...
RIG_CELLS: dict[str, dict[str, tuple[float, float, float, float]]] = {
    ...
    "stoch_s1idz_scv2": {
        "dregon": (15.05, 1.08, 12.81, 17.77),
        "michaels": (14.18, 5.90, 27.63, 9.25),
    },
    "stoch_s1idrp_scv2": {
        "dregon": (15.48, 20.34, 15.87, 14.56),
        "michaels": (10.27, 9.13, 20.34, 5.86),
    },
    "stoch_s1z_scv2": {
        "dregon": (7.20, 10.90, 15.64, 6.16),
        "michaels": (9.20, 4.40, 23.24, 3.50),
    },
    "stoch_s1m_scv2": {
