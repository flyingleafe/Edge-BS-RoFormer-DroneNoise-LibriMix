...
from models.rps_predictor import (
    ...
    SimpleConvV2TransformerLearned,
...
RPS_MODEL_REGISTRY: dict[str, Any] = {
    ...
    "simple_conv_v2_freqpos": SimpleConvV2FreqPos,
    "simple_conv_v2_freqcat": SimpleConvV2FreqCat,
    "simple_conv_v2_freqhires": SimpleConvV2FreqHiRes,
