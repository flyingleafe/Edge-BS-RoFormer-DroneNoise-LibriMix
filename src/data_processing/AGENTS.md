...
- **VK decompositions** (1 materialized, `tdframe-v1`): `decomp-frames-v1` —
  ...
  underestimates and its residual carries the leaked comb energy. Consumers:
