...
Paper protocol: 8 kHz, 3.0 s (24000-sample) crops, noise = the 5 AVQ ego-noise
...
64 ms / 16 ms → n_fft 512, hop 128, dim_f 256, dim_t 188. SI-SDR loss only.
...
`separation_basic` (both restated at 8 kHz in the experiment file). Build the
valid set once with
