...
training_config: conf/experiment/ckla_phaseonly_4s.yaml
...
- **Chunk length**: `conf/online_mix/e12_fullflight_freqscale_v2_4s_dload.yaml`
...
Train: `python train.py experiment=ckla_phaseonly_4s`.
