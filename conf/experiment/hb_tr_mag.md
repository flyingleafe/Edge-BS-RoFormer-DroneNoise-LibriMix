---
experiment: hb_tr_mag
training_config: conf/experiment/hb_tr_mag.yaml
...
doc for the full design). Architecture: Transformer head (simple_conv_v2_transformer). Front-end: `stft_mag`.
...
`python train.py experiment=hb_tr_mag`.
