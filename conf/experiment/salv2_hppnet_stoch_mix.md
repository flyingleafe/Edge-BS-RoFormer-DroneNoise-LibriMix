---
experiment: salv2_hppnet_stoch_mix
training_config: conf/experiment/salv2_hppnet_stoch_mix.yaml
batch: docs/experiments/salv2-speech-and-objective-grid.md
---

# `salv2_hppnet_stoch_mix`
...
**with LibriSpeech mixed in at -30 to 0 dB SNR**, trained on permutation-invariant BCE on four Gaussian per-rotor salience layers.
...
Hydra wiring — data `salv2_stoch_mix` · model `hppnet_rps_l4` · loss `salience_layers_r150` · metrics
`salience_layers_r150`. Train with `python train.py experiment=salv2_hppnet_stoch_mix`.
