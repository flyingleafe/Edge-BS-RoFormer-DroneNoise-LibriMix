...
training_config: conf/experiment/stoch_s1x_scv2.yaml
...
`conf/online_mix/stoch_s1x_dload.yaml`): a smooth colored floor plus one
...
Data `stoch_s1x`, model `simple_conv_v2`, loss `pit_mse`, metrics `rps`, batch 128
...
Train: `python train.py experiment=stoch_s1x_scv2`.
