---
experiment: real_r2_scv2
training_config: conf/experiment/real_r2_scv2.yaml
...
SimpleConvV2 (`simple_conv_v2`, magnitude front end, no voicing gate).
...
Train: `python train.py experiment=real_r2_scv2`.
