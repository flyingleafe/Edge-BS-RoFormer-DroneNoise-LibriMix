---
experiment: b1_dccrn_rpsonly_dregon
training_config: conf/experiment/b1_dccrn_rpsonly_dregon.yaml
batch: docs/experiments/rps-conditioned-se-dregon.md
---

# `b1_dccrn_rpsonly_dregon`
...
DCCRN encoder + RPSPredictionHead, RPS-only loss on DREGON-LM.

Hydra wiring — data `dregon_lm_v1` · model `b1_dccrn_rpsonly_dregon` · loss `pit_mse` · metrics `rps`. Train with `python train.py experiment=b1_dccrn_rpsonly_dregon`,
evaluate with `python eval.py experiment=b1_dccrn_rpsonly_dregon`.
