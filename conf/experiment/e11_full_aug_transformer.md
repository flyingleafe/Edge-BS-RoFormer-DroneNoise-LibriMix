---
experiment: e11_full_aug_transformer
training_config: conf/experiment/e11_full_aug_transformer.yaml
batch: docs/experiments/e10-full-flight.md
---

# `e11_full_aug_transformer`

## Motivation

E11 fixes the two E10 failures for `simple_conv_v2_transformer`: (1) the generator now goes to
...
50% static-comb full_flight + LibriSpeech + augmentation), model `simple_conv_v2_transformer`, loss
...
Train: `python train.py experiment=e11_full_aug_transformer`.
