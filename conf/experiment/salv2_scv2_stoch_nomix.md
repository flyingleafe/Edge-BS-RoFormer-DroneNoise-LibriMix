---
experiment: salv2_scv2_stoch_nomix
training_config: conf/experiment/salv2_scv2_stoch_nomix.yaml
batch: docs/experiments/salv2-speech-and-objective-grid.md
---

# `salv2_scv2_stoch_nomix`
...
**without speech**, trained on permutation-invariant MSE on the rotor speeds.
...
Hydra wiring — data `salv2_stoch_nomix` · model `simple_conv_v2` · loss `pit_mse` · metrics
`rps`. Train with `python train.py experiment=salv2_scv2_stoch_nomix`.
