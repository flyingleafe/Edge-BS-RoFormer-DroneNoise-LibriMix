---
experiment: salv2_scv2_comb_mix
training_config: conf/experiment/salv2_scv2_comb_mix.yaml
...
Hydra wiring — data `salv2_comb_mix` · model `simple_conv_v2` · loss `pit_mse` · metrics
`rps`. Train with `python train.py experiment=salv2_scv2_comb_mix`.
