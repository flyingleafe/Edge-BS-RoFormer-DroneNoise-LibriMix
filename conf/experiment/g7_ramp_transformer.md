---
experiment: g7_ramp_transformer
training_config: conf/experiment/g7_ramp_transformer.yaml
...
step function at 50k samples — this arm (simple_conv_v2_transformer) replaces the step with a
