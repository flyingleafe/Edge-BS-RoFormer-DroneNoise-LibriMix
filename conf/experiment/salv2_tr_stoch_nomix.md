---
experiment: salv2_tr_stoch_nomix
training_config: conf/experiment/salv2_tr_stoch_nomix.yaml
batch: docs/experiments/paper-regime-matrix.md
---

# `salv2_tr_stoch_nomix`

## Motivation

One cell of the SALV2 synthetic grid, extended to a second trunk:
the magnitude-front-end transformer (`simple_conv_v2_transformer`) on the STOCHASTIC rotor-noise family,
WITHOUT speech.
...
`python train.py experiment=salv2_tr_stoch_nomix`.
