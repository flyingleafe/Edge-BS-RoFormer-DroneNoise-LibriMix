---
experiment: hft_r4_l4
training_config: conf/experiment/hft_r4_l4.yaml
...
Hydra wiring — data `m3cur_s2` · model `hft_rps_l4` · loss `salience_layers_r150` · metrics `salience_layers_r150`. Train with `python train.py experiment=hft_r4_l4`.
