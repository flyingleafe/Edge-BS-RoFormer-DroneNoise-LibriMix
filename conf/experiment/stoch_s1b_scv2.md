---
experiment: stoch_s1b_scv2
training_config: conf/experiment/stoch_s1b_scv2.yaml
...
`conf/online_mix/stoch_s1b_dload.yaml`): a smooth colored floor plus one
...
Data `stoch_s1b`, model `simple_conv_v2`, loss `pit_mse`, metrics `rps`, batch 128
...
Train: `python train.py experiment=stoch_s1b_scv2`.
