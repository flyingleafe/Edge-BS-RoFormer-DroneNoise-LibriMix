---
experiment: salv2_scv2_comb_nomix
training_config: conf/experiment/salv2_scv2_comb_nomix.yaml
batch: docs/experiments/salv2-speech-and-objective-grid.md
---

# `salv2_scv2_comb_nomix`
...
for the two salience ports. This cell is **SimpleConvV2, the regressor baseline (BiGRU head, direct rev/s output)** on the **static comb**,
...
Hydra wiring — data `salv2_comb_nomix` · model `simple_conv_v2` · loss `pit_mse` · metrics
`rps`. Train with `python train.py experiment=salv2_scv2_comb_nomix`.
