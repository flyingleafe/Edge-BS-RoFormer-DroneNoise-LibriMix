---
experiment: salv2_tr_comb_nomix
training_config: conf/experiment/salv2_tr_comb_nomix.yaml
...
the magnitude-front-end transformer (`simple_conv_v2_transformer`) on the analytic STATIC COMB,
WITHOUT speech.
...
`python train.py experiment=salv2_tr_comb_nomix`.
