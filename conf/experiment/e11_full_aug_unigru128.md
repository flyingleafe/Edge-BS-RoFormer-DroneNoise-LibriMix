---
experiment: e11_full_aug_unigru128
training_config: conf/experiment/e11_full_aug_unigru128.yaml
batch: docs/experiments/e10-full-flight.md
---

# `e11_full_aug_unigru128`

## Motivation

E11 fixes the two E10 failures for `simple_conv_v2_uni_gru128`: (1) the generator now goes to
...
50% static-comb full_flight + LibriSpeech + augmentation), model `simple_conv_v2_uni_gru128`, loss
...
Train: `python train.py experiment=e11_full_aug_unigru128`.

## Conclusion

Ran 2026-07-12 as the sim-curriculum pretrain stage. Curriculum end-to-end: full-envelope PIT-MSE 179.6. See [e10-full-flight.md](../../docs/experiments/e10-full-flight.md).
