---
experiment: r7hb_tm
training_config: conf/experiment/r7hb_tm.yaml
...
synthetic half — on the magnitude-front-end transformer (`simple_conv_v2_transformer`). This file is
...
Train: `python train.py experiment=r7hb_tm`.
