---
experiment: m3cur_unigru128_s1
training_config: conf/experiment/m3cur_unigru128_s1.yaml
...
Stage 1 of the M3 two-stage RPS-predictor curriculum for the causal unidirectional-GRU head (`simple_conv_v2_uni_gru128`): pre-train
...
Model `simple_conv_v2_uni_gru128`, loss `pit_mse`, metrics `rps`, batch 128 frames,
...
Train: `python train.py experiment=m3cur_unigru128_s1`.
