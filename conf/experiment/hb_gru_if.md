---
experiment: hb_gru_if
training_config: conf/experiment/hb_gru_if.yaml
...
doc for the full design). Architecture: causal GRU-128 head (simple_conv_v2_uni_gru128). Front-end: `stft_mag_if`.
...
`python train.py experiment=hb_gru_if`.
