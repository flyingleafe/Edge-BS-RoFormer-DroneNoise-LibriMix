---
experiment: hb_gru_mag
training_config: conf/experiment/hb_gru_mag.yaml
...
doc for the full design). Architecture: causal GRU-128 head (simple_conv_v2_uni_gru128). Front-end: `stft_mag`.
...
`python train.py experiment=hb_gru_mag`.
