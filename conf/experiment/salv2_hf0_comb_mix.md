---
experiment: salv2_hf0_comb_mix
training_config: conf/experiment/salv2_hf0_comb_mix.yaml
...
Hydra wiring — data `salv2_comb_mix` · model `harmof0_rps_l4` · loss `salience_layers_r150` · metrics
`salience_layers_r150`. Train with `python train.py experiment=salv2_hf0_comb_mix`.
