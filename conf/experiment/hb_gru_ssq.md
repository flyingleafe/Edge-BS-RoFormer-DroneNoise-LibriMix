---
experiment: hb_gru_ssq
training_config: conf/experiment/hb_gru_ssq.yaml
...
doc for the full design). Architecture: causal GRU-128 head (simple_conv_v2_uni_gru128). Front-end: `stft_ssq`.
...
`python train.py experiment=hb_gru_ssq`.
