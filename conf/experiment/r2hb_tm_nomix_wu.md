---
experiment: r2hb_tm_nomix_wu
training_config: conf/experiment/r2hb_tm_nomix_wu.yaml
...
The noise-only arm of the speech A/B on real data for the magnitude transformer
(`simple_conv_v2_transformer`), with the 50k-sample unaugmented warm-up stage of the R2 rows.
...
the exact twin of the R2 row of the same trunk. It replaces `r2hb_tm_nomix`
...
Train: `python train.py experiment=r2hb_tm_nomix_wu`.
