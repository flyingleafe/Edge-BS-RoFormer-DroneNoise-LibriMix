---
experiment: hb_tr_if
training_config: conf/experiment/hb_tr_if.yaml
...
doc for the full design). Architecture: Transformer head (simple_conv_v2_transformer). Front-end: `stft_mag_if`.
...
`python train.py experiment=hb_tr_if`.
