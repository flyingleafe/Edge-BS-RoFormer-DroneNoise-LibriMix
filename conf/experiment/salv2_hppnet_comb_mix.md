---
experiment: salv2_hppnet_comb_mix
training_config: conf/experiment/salv2_hppnet_comb_mix.yaml
batch: docs/experiments/salv2-speech-and-objective-grid.md
---

# `salv2_hppnet_comb_mix`
...
Hydra wiring — data `salv2_comb_mix` · model `hppnet_rps_l4` · loss `salience_layers_r150` · metrics
`salience_layers_r150`. Train with `python train.py experiment=salv2_hppnet_comb_mix`.
