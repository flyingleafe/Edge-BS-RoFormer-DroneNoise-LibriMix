...
training_config: conf/experiment/r4hb_scv2.yaml
...
`m3abl_comb_scv2_s1`'s `best.ckpt`, the same checkpoint the as-run
`m3abl_comb_scv2_s2` used, so the synthetic pre-training is reused, not repeated.
...
`python train.py experiment=r4hb_scv2`.
