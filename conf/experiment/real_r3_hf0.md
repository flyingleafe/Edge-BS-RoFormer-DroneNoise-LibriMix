---
experiment: real_r3_hf0
training_config: conf/experiment/real_r3_hf0.yaml
...
Rung 3 of the reality ladder — TWO rigs (DREGON + Michael's FLY125), ALL 8 microphones — on the salience
port HarmoF0 (`harmof0_rps_l4`).
...
This file is `hf0_r2hb_l4` with the training stream replaced by
`conf/online_mix/real_r3_dload.yaml` and nothing else changed; like its source it trains
...
Train: `python train.py experiment=real_r3_hf0`.
