---
experiment: salv2_hppnet_stoch_nomix
training_config: conf/experiment/salv2_hppnet_stoch_nomix.yaml
batch: docs/experiments/salv2-speech-and-objective-grid.md
---

# `salv2_hppnet_stoch_nomix`
...
Hydra wiring — data `salv2_stoch_nomix` · model `hppnet_rps_l4` · loss `salience_layers_r150` · metrics
`salience_layers_r150`. Train with `python train.py experiment=salv2_hppnet_stoch_nomix`.
