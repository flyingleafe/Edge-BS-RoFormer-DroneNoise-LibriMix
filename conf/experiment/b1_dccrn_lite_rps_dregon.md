---
experiment: b1_dccrn_lite_rps_dregon
training_config: conf/experiment/b1_dccrn_lite_rps_dregon.yaml
batch: docs/experiments/rps-conditioned-se-dregon.md
---

# `b1_dccrn_lite_rps_dregon`
...
DCCRNLite (embedded-deployment variant) + RPS fusion on DREGON-LM.

Hydra wiring — data `dregon_lm_v1` · model `b1_dccrn_lite_rps_dregon` · loss `masked_mse` · metrics `separation_basic`. Train with `python train.py experiment=b1_dccrn_lite_rps_dregon`,
evaluate with `python eval.py experiment=b1_dccrn_lite_rps_dregon`.
