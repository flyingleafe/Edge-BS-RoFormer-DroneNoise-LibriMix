...
Ran 2026-07-11. Best val PIT-MSE 222.3 (R² −10.5) — on the **contaminated** valid (`min_motor_rps=30`); never rescored on the clean split. Verdict revised by the valid-set fix: see the conclusion of [e7-gen-curriculum.md](../../docs/experiments/e7-gen-curriculum.md).
