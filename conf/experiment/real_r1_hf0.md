---
experiment: real_r1_hf0
training_config: conf/experiment/real_r1_hf0.yaml
...
Rung 1 of the reality ladder — ONE rig (DREGON), ONE microphone — on the salience
...
`conf/online_mix/real_r1_dload.yaml` and nothing else changed; like its source it trains
...
Train: `python train.py experiment=real_r1_hf0`.
