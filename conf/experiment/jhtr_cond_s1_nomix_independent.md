---
experiment: jhtr_cond_s1_nomix_independent
training_config: conf/experiment/jhtr_cond_s1_nomix_independent.yaml
parent: jhtr_cond_s1_nomix
---

# `jhtr_cond_s1_nomix_independent`

## Motivation

Remove cross-slot attention and competing-trajectory descriptors, including in the initializer; retain per-slot capacity and global audio memory.

## Setup

Hydra inherits [`jhtr_cond_s1_nomix.yaml`](jhtr_cond_s1_nomix.yaml), then applies only the declared JHTR overrides. All data, conditioning, loss, model width/block count, seeds and optimization settings come from the full conditional parent. Only the named mechanism flag and experiment identifier change.
