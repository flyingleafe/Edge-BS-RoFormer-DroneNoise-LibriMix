---
experiment: hf0_comb_l4
training_config: conf/experiment/hf0_comb_l4.yaml
...
Hydra wiring — data `sal_comb_synthval` · model `harmof0_rps_l4` · loss `salience_layers_r150` · metrics `salience_layers_r150`. Train with `python train.py experiment=hf0_comb_l4`.
