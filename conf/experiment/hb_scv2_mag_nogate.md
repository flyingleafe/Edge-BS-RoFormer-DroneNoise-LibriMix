...
training_config: conf/experiment/hb_scv2_mag_nogate.yaml
...
doc for the full design). Architecture: BiGRU head (simple_conv_v2). Front-end: `stft_mag`.
Voicing gate: no. Data: the `hb` regime
...
`python train.py experiment=hb_scv2_mag_nogate`.
