---
experiment: hppnet_r2hb_nomix
training_config: conf/experiment/hppnet_r2hb_nomix.yaml
...
HPPNet (`hppnet_rps_l4`). This file is `hppnet_r2hb_l4` with the training stream
...
Train: `python train.py experiment=hppnet_r2hb_nomix`.
