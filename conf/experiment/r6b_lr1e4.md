...
training_config: conf/experiment/r6b_lr1e4.yaml
batch: docs/experiments/unified-baseline-eval.md
---

# r6b_lr1e4 — learning-rate ladder on the mixed curriculum

## Motivation

See the header of `conf/experiment/r6b_lr1e4.yaml` for the arm's role.
