---
experiment: jhtr_cond_s1_nomix_frozen
training_config: conf/experiment/jhtr_cond_s1_nomix_frozen.yaml
parent: jhtr_cond_s1_nomix
---

# `jhtr_cond_s1_nomix_frozen`

## Motivation

Read local observations at initialization only; retain all six update blocks and their learned weights.
