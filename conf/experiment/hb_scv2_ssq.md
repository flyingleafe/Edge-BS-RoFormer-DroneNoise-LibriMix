---
experiment: hb_scv2_ssq
training_config: conf/experiment/hb_scv2_ssq.yaml
...
doc for the full design). Architecture: BiGRU head (simple_conv_v2). Front-end: `stft_ssq`.
...
`python train.py experiment=hb_scv2_ssq`.
