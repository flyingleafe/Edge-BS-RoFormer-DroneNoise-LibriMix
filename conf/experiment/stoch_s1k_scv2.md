---
experiment: stoch_s1k_scv2
training_config: conf/experiment/stoch_s1k_scv2.yaml
...
`conf/online_mix/stoch_s1k_dload.yaml`.
...
Everything else is `stoch_s1j_scv2`: the narrowed widths that produced the
...
Data `stoch_s1k`, model `simple_conv_v2`, loss `pit_mse`, metrics `rps`, batch
...
Train: `python train.py experiment=stoch_s1k_scv2`.
