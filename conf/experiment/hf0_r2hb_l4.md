---
experiment: hf0_r2hb_l4
training_config: conf/experiment/hf0_r2hb_l4.yaml
...
HarmoF0 (`harmof0_rps_l4`). This file is `hf0_r4_l4` with two changes.
...
Train: `python train.py experiment=hf0_r2hb_l4`.
