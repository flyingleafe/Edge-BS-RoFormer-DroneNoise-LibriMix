---
experiment: e12_real_fullflight_unigru128
training_config: conf/experiment/e12_real_fullflight_unigru128.yaml
...
noise from the question: train `simple_conv_v2_uni_gru128` on the REAL full flight by
...
FLY125, online mix + E5 time-warp + augmentation), model `simple_conv_v2_uni_gru128`,
loss `pit_mse`, metrics `rps`. epochs 200, patience 20, batch 16. Valid
`dload:DREGON-LM-V4-michaels-valid-full` (FLY124 — no leakage).

Train: `python train.py experiment=e12_real_fullflight_unigru128`.
