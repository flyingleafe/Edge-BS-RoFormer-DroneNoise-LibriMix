---
experiment: b1_dccrn_baseline_dregon
training_config: conf/experiment/b1_dccrn_baseline_dregon.yaml
batch: docs/experiments/rps-conditioned-se-dregon.md
---

# `b1_dccrn_baseline_dregon`
...
DCCRN baseline, no RPS, on DREGON-LM.

Hydra wiring — data `dregon_lm_v1` · model `b1_dccrn_baseline_dregon` · loss `masked_mse` · metrics `separation_basic`. Train with `python train.py experiment=b1_dccrn_baseline_dregon`,
evaluate with `python eval.py experiment=b1_dccrn_baseline_dregon`.
