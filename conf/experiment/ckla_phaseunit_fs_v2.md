---
experiment: ckla_phaseunit_fs_v2
training_config: conf/experiment/ckla_phaseunit_fs_v2.yaml
batch: docs/experiments/ckla.md
---

# `ckla_phaseunit_fs_v2`
...
policy p=1.0, α∈[0.7, 1.3]) with `simple_conv_v2_ckla_phaseunit`
(readout="phase_unit"). Compare against `ckla_pnoise_fs_v2`,
`ckla_phasediff_fs_v2`, and `ckla_norot_fs_v2`. Scale-response probe +
cruise pools as in the fs_v2 batch.

Train: `python train.py experiment=ckla_phaseunit_fs_v2`.
