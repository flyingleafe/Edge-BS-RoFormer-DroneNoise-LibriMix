---
experiment: ladder_r1_scv2
training_config: conf/experiment/ladder_r1_scv2.yaml
...
`gamma_slope_hz` [0.0, 0.05], warm-started from rung 0 (`ladder_r0_scv2`). Trains the 1.5M SimpleConvV2 trunk on
`conf/online_mix/ladder_r1_dload.yaml` and validates on half the frozen real
