---
experiment: f1_edge_bs_rof_a
training_config: conf/experiment/f1_edge_bs_rof_a.yaml
...
Edge-BS-RoFormer (band-split transformer, Paper 1 in-house SOTA), Pass A (drone noises only) of the F1 blind speech-enhancement baseline
...
`python train.py experiment=f1_edge_bs_rof_a`, evaluate with
`python eval.py experiment=f1_edge_bs_rof_a metrics=separation_full`.
