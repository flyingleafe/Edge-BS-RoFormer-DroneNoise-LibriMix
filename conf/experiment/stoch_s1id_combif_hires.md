---
experiment: stoch_s1id_combif_hires
training_config: conf/experiment/stoch_s1id_combif_hires.yaml
batch: docs/experiments/stochastic-transfer.md
---

# `stoch_s1id_combif_hires`
...
Train: `python train.py experiment=stoch_s1id_combif_hires`.
