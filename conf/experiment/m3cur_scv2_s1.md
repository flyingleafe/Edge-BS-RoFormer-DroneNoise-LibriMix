...
training_config: conf/experiment/m3cur_scv2_s1.yaml
...
Stage 1 of the M3 two-stage RPS-predictor curriculum for the plain BiGRU baseline (`simple_conv_v2`): pre-train
...
Model `simple_conv_v2`, loss `pit_mse`, metrics `rps`, batch 128 frames,
...
Train: `python train.py experiment=m3cur_scv2_s1`.

## Conclusion

Ran 2026-08-20/21. Best val/mse 325.5 at 40 epochs, generated-only. Stage for m3cur_scv2_s2.
