---
experiment: e10_full_unigru128
training_config: conf/experiment/e10_full_unigru128.yaml
...
Train `simple_conv_v2_uni_gru128` on the FULL-FLIGHT combined synthetic noise task with NO
...
model `simple_conv_v2_uni_gru128`, loss `pit_mse`, metrics `rps`. epochs 200, patience 20,
...
Train: `python train.py experiment=e10_full_unigru128`.
