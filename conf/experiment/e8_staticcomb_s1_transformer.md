---
experiment: e8_staticcomb_s1_transformer
training_config: conf/experiment/e8_staticcomb_s1_transformer.yaml
batch: docs/experiments/e8-static-comb.md
---

# `e8_staticcomb_s1_transformer`

## Motivation

E8 sim-to-real probe with the analytic **static-comb** noise model (simple_conv_v2_transformer
head — the E5 time-warp best-overall arch). Amplitudes are static and RPS-independent and >=30% of each
...
valid), model `simple_conv_v2_transformer`, loss `pit_mse`, metrics `rps`. Patience 8, batch 16,
...
Train: `python train.py experiment=e8_staticcomb_s1_transformer`.
