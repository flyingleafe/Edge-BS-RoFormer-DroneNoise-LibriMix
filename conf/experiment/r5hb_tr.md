---
experiment: r5hb_tr
training_config: conf/experiment/r5hb_tr.yaml
...
(`simple_conv_v2_transformer_if`). What differs from the as-run `m3abl_mixed_transformer` is the real
...
`python train.py experiment=r5hb_tr`.
