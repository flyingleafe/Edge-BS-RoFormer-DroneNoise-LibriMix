---
experiment: e10_full_scv2
training_config: conf/experiment/e10_full_scv2.yaml
...
Train `simple_conv_v2` on the FULL-FLIGHT combined synthetic noise task with NO
...
model `simple_conv_v2`, loss `pit_mse`, metrics `rps`. epochs 200, patience 20,
...
Train: `python train.py experiment=e10_full_scv2`.
