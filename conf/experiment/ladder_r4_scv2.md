...
Realized comb contrast 7.3 dB, warm-started from rung 3 (`ladder_r3_scv2`). Trains the 1.5M SimpleConvV2 trunk
on `conf/online_mix/ladder_r4_dload.yaml` and validates on half the frozen
