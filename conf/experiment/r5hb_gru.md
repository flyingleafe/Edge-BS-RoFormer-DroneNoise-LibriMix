---
experiment: r5hb_gru
training_config: conf/experiment/r5hb_gru.yaml
...
(`simple_conv_v2_uni_gru128`). What differs from the as-run `m3abl_mixed_unigru128` is the real
...
`python train.py experiment=r5hb_gru`.
