...
Transformer result after it. \wip{PENDING: the mixed single-stage ablation
(real + synthetic in one pool, same schedule) decides whether the two-stage
curriculum itself is necessary.}
