# Work inventory — deck extension (Part 2: CKLA campaign)

> Part-1 (DCUNet) content is already in the deck (commit e84bb1b) — do not rebuild it.
> Part-2 sources = the CKLA campaign window below (copied from the 2026-07-27 report inventory),
> PLUS the post-report discoveries: docs/experiments/ckla.md § THE STAGING BUG (the central new fact),
> the protocol reset commit (legacy-equivalent epochs/batch), and results/ckla_levers_probes2 numbers.
