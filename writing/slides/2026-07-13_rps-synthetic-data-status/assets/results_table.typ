#figure(
  ...
  caption: [Per-regime and overall PIT-MSE on the full-envelope real validation set (27 cruise / 6 warm-up / 4 ground clips). Lower is better; bold = best "All" per architecture.],
) <tab-results>
