...
LAYERS_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "PlotNeuralNet"))
...
def _arrow(src, dst):
    return (
        r"\draw [connection]  (" + src + r"-east) -- node {\midarrow} (" + dst + r"-west);" + "\n"
    )
